...
const mouseCircleTransform = (hoveredEl) => {
  if (hoveredEl.classList.contains("pointer-enter")) {
    hoveredEl.onmousemove = () => {
      ...
      mouseCircle.style.cssText = `width: ${
        hoveredEl.getBoundingClientRect().width
      }px;
...
const aboutMeTextContent =
  "I am a Web developer from Norway, based out of Trondheim, Norway. I primarily focus on the Frontend part of web development, to give the best experience for users. I'm allways up for a challange, I never says no to an oppertunity to learn and improve my skills and understanding of codes.";
